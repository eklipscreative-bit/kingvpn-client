...
import 'package:kingvpn/core/db/database/constants.dart';
...
class AppPalette {
  ...
  static const light = AppPalette(
    ...
    primary: Color(0xFF0F9D4B),
    primaryHover: Color(0xFF0B783C),
    primarySolid: Color(0xFF0F9D4B),
    primarySolidHover: Color(0xFF0B783C),
    ...
    accent: Color(0xFFE4F7EB),
    accentForeground: Color(0xFF0F9D4B),
    ...
    ring: Color(0xFF0F9D4B),
    selection: Color(0xFFE4F7EB),
    scannerBackground: Color(0xFF0B2B18),
    overlay: Color.fromRGBO(9, 17, 29, 0.48),
    header: Color(0xFFFEFEFE),
    brand: Color(0xFF0A3B20),
    sidebar: Color(0xFFF8FAFC),
    sidebarForeground: Color(0xFF565D6D),
    sidebarPrimary: Color(0xFF0F9D4B),
    sidebarPrimaryForeground: Color(0xFFFFFFFF),
    sidebarAccent: Color(0xFFE2F2E6),
    sidebarAccentForeground: Color(0xFF0B542C),
    sidebarBorder: Color(0xFFDAE0E5),
    sidebarRing: Color(0xFF0F9D4B),
    selectedSurface: Color(0xFFE4F7EB),
  ...
  static const dark = AppPalette(
    ...
    primary: Color(0xFF3BE386),
    primaryHover: Color(0xFF5BE99B),
    primarySolid: Color(0xFF0F9D4B),
    primarySolidHover: Color(0xFF0C8541),
    primaryForeground: Color(0xFFFFFFFF),
    ...
    accent: Color(0xFF11351F),
    accentForeground: Color(0xFF3BE386),
    ...
    ring: Color(0xFF3BE386),
    selection: Color(0xFF11351F),
    scannerBackground: Color(0xFF0B2B18),
    overlay: Color.fromRGBO(9, 17, 29, 0.48),
    header: Color(0xFF10151E),
    brand: Color(0xFFB2EFCB),
    sidebar: Color(0xFF151C27),
    sidebarForeground: Color(0xFFC2CAD5),
    sidebarPrimary: Color(0xFF3BE386),
    sidebarPrimaryForeground: Color(0xFFFFFFFF),
    sidebarAccent: Color(0xFF132D1D),
    sidebarAccentForeground: Color(0xFFC6F5D7),
    sidebarBorder: Color(0xFF2B3543),
    sidebarRing: Color(0xFF3BE386),
    selectedSurface: Color(0xFF11351F),
