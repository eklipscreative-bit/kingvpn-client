...
import 'package:kingvpn/pages/settings/app_icon/controller.dart';
...
import 'package:kingvpn/service/settings/data_cleanup.dart';
import 'package:kingvpn/service/launch/app_startup.dart';
import 'package:kingvpn/service/shared/doc/helper.dart';
...
class SettingsController extends PageCubit<SettingsPageState> {
  ...
  Future<void> openLink(BuildContext context, SettingsLink link) async {
    ...
    final uri = switch (link) {
      SettingsLink.plan => Uri.parse('https://sub.conectsoft.shop/'),
      SettingsLink.documentation => DocURLHelper.docUri(),
      SettingsLink.review => null,
      SettingsLink.community => Uri.parse('https://sub.conectsoft.shop/'),
      SettingsLink.feedback => Uri.parse('https://sub.conectsoft.shop/'),
      SettingsLink.source => Uri.parse('https://sub.conectsoft.shop/'),
