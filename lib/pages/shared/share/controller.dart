...
import 'package:kingvpn/core/tools/file.dart';
...
import 'package:kingvpn/service/settings/language/service.dart';
...
enum ShareLinkFormat { original, kingvpn }
...
class ShareController extends PageCubit<SharePageState> {
  ...
  late final _appLinkShareService = KingVpnAppLinkShareService(
