...
abstract final class KingVpnAppLinkParser {
  static const scheme = 'kingvpn';
  static const host = 'sub.conectsoft.shop';

  static const configPath = '/config/add';
  static const subscriptionPath = '/sub/add';
  static const geoDataPath = '/dat/add';

  static KingVpnAppLink? parse(Uri uri) {
  ...
  static KingVpnConfigLink? _parseConfig(Uri uri) {
    ...
    final type = switch (typeText) {
      ...
      'custom' => KingVpnConfigLinkType.custom,
      _ => null,
    };
    if (type == null) {
      return null;
  ...
  static KingVpnSubscriptionLink? _parseSubscription(Uri uri) {
  ...
  static KingVpnGeoDataLink? _parseGeoData(Uri uri) {
    ...
    return KingVpnGeoDataLink(name: _fragmentName(uri), type: type, url: url);
  }
