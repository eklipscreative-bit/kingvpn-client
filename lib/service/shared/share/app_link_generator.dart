...
abstract final class KingVpnAppLinkGenerator {
  static Uri configurationText(
    KingVpnConfigLinkType type,
    String name,
    String text,
  ) => Uri(
    scheme: KingVpnAppLinkParser.scheme,
    host: KingVpnAppLinkParser.host,
    path: KingVpnAppLinkParser.configPath,
    queryParameters: {
      'type': type.wireName,
  ...
  static Uri? config(CoreConfigData config) {
    ...
    if (type == KingVpnConfigLinkType.outbound) {
      try {
        data = base64Encode(
  ...
  static Uri? subscription(SubscriptionData subscription) {
    ...
    return _verified(
      Uri(
        scheme: KingVpnAppLinkParser.scheme,
        host: KingVpnAppLinkParser.host,
        path: KingVpnAppLinkParser.subscriptionPath,
  ...
  static Uri? _verified(Uri uri) {
    return KingVpnAppLinkParser.parse(uri) == null ? null : uri;
  }
