...
class ConfigurationTransferService {
  ...
  Future<String> shareLinks({
    ...
    links.add(
      KingVpnAppLinkGenerator.configurationText(
        kind == ConfigurationKind.raw
            ? KingVpnConfigLinkType.raw
            : KingVpnConfigLinkType.custom,
        name,
