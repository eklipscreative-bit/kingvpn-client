...
import 'package:kingvpn/pages/settings/controller.dart';
import 'package:kingvpn/pages/settings/widgets.dart';
import 'package:kingvpn/pages/settings/app_icon/page.dart';
import 'package:kingvpn/pages/settings/desktop/controller.dart';
...
import 'package:kingvpn/pages/shared/widgets/setting_row.dart';
import 'package:kingvpn/pages/shared/widgets/button_progress.dart';
import 'package:kingvpn/pages/shared/widgets/settings_page.dart';
          ...
          body: SafeArea(
            child: BlocBuilder<AppEventBus, AppEventBusState>(
              builder: (context, preferences) {
                ...
                final plan = SettingSection(
                  title: l10n.settingsPagePlanTitle,
                  icon: LucideIcons.shopping_cart,
                  padding: EdgeInsets.zero,
                  dividerIndent: 0,
                  children: [
                    SettingRow(
                      title: l10n.settingsPageBuyPlan,
                      subtitle: l10n.settingsPageBuyPlanHint,
                      minHeight: rowHeight,
                      contentPadding: rowPadding,
                      titleStyle: AppTypography.settingsRow,
                      subtitleStyle:
