...
import 'package:kingvpn/pages/advanced/xray/log/page.dart';
import 'package:kingvpn/pages/advanced/xray/log/params.dart';
import 'package:kingvpn/pages/advanced/xray/config/page.dart';
import 'package:kingvpn/pages/advanced/xray/config/params.dart';
import 'package:kingvpn/pages/advanced/xray/ping/page.dart';
import 'package:kingvpn/pages/settings/about/page.dart';
import 'package:kingvpn/pages/advanced/tunnel/apple/page.dart';
import 'package:kingvpn/pages/advanced/tunnel/apple/wifi.dart';
import 'package:kingvpn/pages/advanced/tunnel/android/page.dart';
import 'package:kingvpn/pages/advanced/tunnel/android/apps.dart';
import 'package:kingvpn/pages/advanced/tunnel/windows/page.dart';
import 'package:kingvpn/pages/advanced/tunnel/interface/page.dart';
import 'package:kingvpn/pages/advanced/xray/geodata/page.dart';
import 'package:kingvpn/pages/advanced/xray/geodata/detail.dart';
import 'package:kingvpn/service/advanced/policy_editor.dart';
import 'package:kingvpn/service/connect/routing/custom/state.dart';
import 'package:kingvpn/pages/shared/share/page.dart';
import 'package:kingvpn/pages/shared/share/params.dart';
import 'package:kingvpn/pages/launch/splash/page.dart';
import 'package:kingvpn/pages/main/adaptive_shell.dart';
import 'package:kingvpn/pages/main/dialog_page.dart';
import 'package:kingvpn/pages/main/navigation.dart';
import 'package:kingvpn/pages/shared/widgets/adaptive_dialog.dart';
import 'package:kingvpn/pages/theme/color.dart';
import 'package:kingvpn/pages/launch/setup/page.dart';
import 'package:kingvpn/pages/launch/setup/selectors.dart';
import 'package:kingvpn/pages/servers/import/page.dart';
import 'package:kingvpn/pages/servers/page.dart';
import 'package:kingvpn/pages/connect/routing/smart/exit_picker.dart';
import 'package:kingvpn/pages/servers/controller.dart';
import 'package:kingvpn/pages/connect/routing/smart/exit_picker_controller.dart';
import 'package:kingvpn/pages/servers/editor/page.dart';
import 'package:kingvpn/pages/servers/subscription/page.dart';
import 'package:kingvpn/pages/connect/raw_editor/page.dart';
import 'package:kingvpn/pages/connect/routing/smart/page.dart';
import 'package:kingvpn/pages/connect/routing/smart/regions.dart';
import 'package:kingvpn/pages/connect/routing/custom/page.dart';
import 'package:kingvpn/pages/connect/routing/custom/rule_page.dart';
import 'package:kingvpn/pages/settings/app_update/dialog.dart';
import 'package:kingvpn/pages/settings/app_update/params.dart';
import 'package:kingvpn/pages/settings/app_icon/page.dart';
import 'package:kingvpn/pages/advanced/xray/data_update/page.dart';
import 'package:kingvpn/pages/settings/desktop/page.dart';
import 'package:kingvpn/pages/settings/language/page.dart';
import 'package:kingvpn/pages/settings/theme/page.dart';
import 'package:kingvpn/pages/servers/subscription/params.dart';
...
final _sharedSecondaryRoutes = <_SharedSecondaryRoute>[
  ...
  _route(
    AppSecondaryDestination.aboutKingVpn,
    (_, _) => const AboutKingVpnPage(),
  ),
];
