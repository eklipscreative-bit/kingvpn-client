...
@ConfigurePigeon(
  PigeonOptions(
    ...
    kotlinOut:
        'android/app/src/main/kotlin/com/kingmobile/kingvpncliente/pigeon/Messages.g.kt',
    kotlinOptions: KotlinOptions(package: "com.kingmobile.kingvpncliente.pigeon"),
    swiftOut: 'swift/App/pigeon/Messages.g.swift',
    swiftOptions: SwiftOptions(),
    dartPackageName: 'kingvpn',
  ),
)
@HostApi()
