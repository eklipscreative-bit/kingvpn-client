...
class BridgeHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: BridgeHostApi?, messageChannelSuffix: String = "") {
    ...
    let getTunFilesDirChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.getTunFilesDir\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let readVpnStatusChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.readVpnStatus\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let startVpnChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.startVpn\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stopVpnChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.stopVpn\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let invokeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.invoke\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let queryPlatformPermissionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.queryPlatformPermission\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let requestPlatformPermissionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.requestPlatformPermission\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getInstalledAppsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.getInstalledApps\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getAppIconChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.getAppIcon\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let useSystemExtensionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.useSystemExtension\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let appleVpnCapabilitiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.appleVpnCapabilities\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let queryLaunchAtLoginChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.queryLaunchAtLogin\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setLaunchAtLoginChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.setLaunchAtLogin\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let openLaunchAtLoginSettingsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.openLaunchAtLoginSettings\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAppIconChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.setAppIcon\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCurrentAppIconChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.kingvpn.BridgeHostApi.getCurrentAppIcon\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class BridgeFlutterApi: BridgeFlutterApiProtocol {
  ...
  func vpnStatusChanged(status statusArg: VpnStatus, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.kingvpn.BridgeFlutterApi.vpnStatusChanged\(messageChannelSuffix)"
  ...
  func refreshVpn(result resultArg: RefreshVpnResult, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.kingvpn.BridgeFlutterApi.refreshVpn\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
